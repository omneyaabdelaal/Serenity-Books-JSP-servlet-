            ...
            %>
                <form action="BooksController" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="desc" name="desc" value="<%= book.getDesc() %>" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="issue-date">Issue Date</label>
                        <input type="Date" id="issue-date" name="issue-date" value="<%= book.getIssue_date() %>" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="ex-date">Expire Date</label>
                        <input type="Date" id="ex-date" name="ex-date" value="<%= book.getExpire_date() %>" required>
                    </div>
